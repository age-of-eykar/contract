...
namespace Vec64x61:
    ...
    func add {range_check_ptr} (a: (felt, felt, felt), b: (felt, felt, felt)) -> (res: (felt, felt, felt)):
    ...
    func sub {range_check_ptr} (a: (felt, felt, felt), b: (felt, felt, felt)) -> (res: (felt, felt, felt)):
    ...
    func cross {range_check_ptr} (a: (felt, felt, felt), b: (felt, felt, felt)) -> (res: (felt, felt, felt)):
