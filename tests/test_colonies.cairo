...
from contracts.colonies import Colony, create_colony, get_colony, redirect_colony
...
func test_create_colony{syscall_ptr : felt*, range_check_ptr, pedersen_ptr : HashBuiltin*}():
    ...
    let (colony : Colony) = get_colony(colony1.redirection)
...
func test_redirect_colony{syscall_ptr : felt*, range_check_ptr, pedersen_ptr : HashBuiltin*}():
    ...
    redirect_colony(2, 1)
    let (colony1 : Colony) = get_colony(1)
    let (colony2 : Colony) = get_colony(2)
