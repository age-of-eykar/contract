...
from contracts.map.biomes import get_elevation, get_temperature, assert_not_ocean, assert_jungle_or_forest
...
func test_elevation{range_check_ptr}():
    ...
    let (a) = abs_value(elevation - 3618502788666131213697322783095070105623107215331596699972979827924770103729)
