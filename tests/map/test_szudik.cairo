...
func test_szudzik_lcg{range_check_ptr}() {
    ...
    let (szudzik3) = random_szudzik(
        3618502788666131213697322783095070105623107215331596699973092056135872020476, 10456, 1
    );
    let (szudzik4) = random_szudzik(
        3618502788666131213697322783095070105623107215331596699973092056135871341988,
        3618502788666131213697322783095070105623107215331596699973092056135862020482,
        1,
    );
